...
**Dernière MAJ** : 2026-06-29 — **A4 mergée sur main (squash `cab71ce09`, PR #36)**. 1642 fichiers courts `eletricista-{ville}.html` à la racine désormais conformes Doctrine §12 : bloc Doctrine (70 €/h + Z1-Z6 + +50% + NAP 932 321 892 + équipement Fluke/Megger/ROLeak/FLIR), noindex retiré, fourchettes « Desde X € » (40/45/55/60/65/70/75/80/85/90/95/100/105/110/115/120/125/130/135/140/145/150/180/280/850) → « sob orçamento por escrito », « orçamento grátis » → « por escrito », « Resposta prioritária » → « atendimento mediante confirmação por téléphone », « Acréscimos noturnos 18h-08h » → « Majoração noite (20h-8h), domingo e feriado: +50% ». Branche `a4-doctrine-pages-courtes` supprimée après merge.
**Prochaine action** : **A4-BIS élec = cleanup résiduel** : (1) 180 fichiers services A2 où « orçamento grátis » a survécu (idempotence A4 a skip A2 sur ces fichiers) ; (2) 271 fichiers avec `+351****1892` (typo d'origine A2 — devrait être `4892`) ; (3) `12+ Anos de Experiência` (-1) + `canalizador-bleed` (-1) introduits involontairement par A4. Cross-site drift 928/65 €/h/Ridgid vérifié à 0. Backup `/tmp/a4-backup-eletricista-2026-06-29/` supprimable après validation.
