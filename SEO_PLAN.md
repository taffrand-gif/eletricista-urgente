...
| T3-INFO-tipos-de-cabos | Combler GSC gap eu 'tipos de cabos' pos=8 (20 impr / 0 clics 28j) | MOYENNE | ⏸ → ✅ après GO | #391 DRAFT | — | `tipos de cabos` · query verbatim absente du H1 de la page canonique `/blog/cabo-eletrico-tipos` (H1 actuel « Tipos de Cabos Elétricos » — ne matche pas verbatim, Google classe hors top3 → 0 clic) · **stratégie = renforcer** la page existante (pas de nouvelle page) : H1 + title + excerpt + keywords intègrent « tipos de cabos » verbatim, 3 nouvelles FAQ (9-10-11) verbatim, intro réécrite, date/lastmod 2026-09-22, re-rendu via `scripts/render-blog-md.js` (28 occurrences verbatim dans le HTML rendu, 11 FAQ dont 3 verbatim) · branche `fix/eu-gsc-gap-tipos-de-cabos-t_49bcab85` · R7 : STOP merge + GO Filipe |
