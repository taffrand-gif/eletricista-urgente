...
selon les zones officielles 2026
"""
...
def fix_price_in_file(filepath):
    ...
    # Pattern pour trouver la ligne de prix
    # <tr><td>Deslocação Urgente [Ville]</td><td>XX€</td></tr>
    pattern = r'(<tr><td>Deslocação Urgente [^<]+</td><td>)\d+€(</td></tr>)'
