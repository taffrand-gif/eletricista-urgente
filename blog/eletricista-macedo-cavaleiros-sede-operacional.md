...
Em Macedo fazemos: diagnóstico e reparação de avarias, substituição de quadros elétricos, instalação de iluminação LED interior e exterior, certificação elétrica DGEG, instalação de carregadores para veículos elétricos, sistemas solares fotovoltaicos. Somos certificados e emitimos documentação oficial.
