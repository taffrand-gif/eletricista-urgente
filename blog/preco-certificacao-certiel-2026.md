...
**Segurança:** Garante que a instalação não apresenta riscos de choque elétrico ou incêndio.

**Legalidade:** Obrigatória por lei (Decreto-Lei 226/2005) para proteger compradores e inquilinos.

**Valorização:** Imóvel certificado vale mais e vende/arrenda mais rápido.

**Seguros:** Muitas seguradoras exigem certificação para cobrir danos elétricos.
...
|-------------|----------|--------|-------------|-------|
| **Apartamento T1-T2** | 120€ | 50€ | 30€ | **200€** |
| **Casa T3-T4** | 180€ | 70€ | 30€ | **280€** |
| **Casa T4+** | 250€ | 70€ | 30€ | **350€** |
| **Moradia grande (T5+)** | 350€ | 100€ | 30€ | **480€** |

### Comércio e Indústria

| Tipo | Área | Preço Base | Preço Final |
|------|------|------------|-------------|
| **Loja pequena** | <50m² | 300€ | 300-400€ |
| **Loja média** | 50-150m² | 400€ | 400-600€ |
...
1. **Venda de imóvel** - Sem certificado, não pode vender legalmente. Saiba mais sobre [certificação obrigatória](https://eletricista-urgente.pt/blog/certificacao-eletrica-obrigatoria-quando-como).
...
5. **Ampliação de potência** - Aumentar potência contratada
6. **Ligação equipamentos alta potência** - Bombas calor, carregadores elétricos

### RECOMENDADA (Mas Não Obrigatória) ⚠️

1. **Seguro habitação** - Algumas seguradoras exigem ou dão desconto
2. **Imóvel com +20 anos** - Verificar segurança instalação. Veja [como escolher eletricista confiável](https://eletricista-urgente.pt/blog/melhores-eletricistas-braganca-2026).
...
- Fatura eletricidade (para confirmar potência)
- Projeto elétrico (se tiver, não obrigatório)
...
**Quadro elétrico:**
- Disjuntor geral adequado à potência
- Disjuntores divisórios corretos
- Diferencial 30mA presente e funcional
- Proteção sobretensões (recomendado)
- Identificação circuitos

**Instalação:**
- Tomadas com terra
- Cabos com secção adequada
- Caixas de derivação acessíveis
- Iluminação conforme
- Ligação terra presente

**Segurança:**
- Sem cabos expostos
- Sem ligações improvisadas
- Sem sinais de sobreaquecimento
- Distâncias segurança água/gás

**Duração:** 1-2 horas (T3), 2-3 horas (T5+)

### PASSO 3: Testes Elétricos (Dia 1)

**Testes obrigatórios:**

**1. Continuidade de terra**
- Verifica se terra está ligada em todas tomadas
- Resistência <1 Ohm

**2. Isolamento**
- Mede resistência isolamento cabos
- Mínimo 1 MΩ (megaohm)

**3. Diferencial**
- Testa se diferencial dispara em <30ms
- Protege contra choques elétricos

**4. Polaridade**
- Confirma fase/neutro corretos
- Evita choques em aparelhos

**Equipamento usado:**
- Multímetro digital
- Megger (testador isolamento)
...
- Falta diferencial 30mA: 75-95€
- Falta ligação terra: 180-250€
- Cabos secção inadequada: 110-160€/circuito
- Quadro antigo fusíveis: 370-650€
...
**Validade:** Indefinida (mas recomenda-se renovar a cada 10 anos)
...
|------------|----|----|-----|------------|
| **Bragança** | 200€ | 280€ | 350€ | Incluída |
| **Mirandela** | 200€ | 280€ | 350€ | Incluída |
| **Macedo Cavaleiros** | 200€ | 280€ | 350€ | Incluída |
| **Chaves** | 200€ | 280€ | 350€ | Incluída |
...
| Correções (ex: adicionar diferencial) | 1-2 horas |
...
| Correções (ex: mudar quadro) | 1-2 dias |
...
### 1. Preparar Documentação Antecipadamente
- Caderneta predial
- Fatura eletricidade
- Projeto elétrico (se tiver)

**Ganho:** -1 dia

### 2. Garantir Acesso Total
...
Se sabe que tem problemas (ex: falta diferencial), corrija antes da inspeção. Veja [quando vale a pena fazer você mesmo](https://eletricista-urgente.pt/blog/eletricista-vs-bricolagem-quando-vale-pena).
...
### 3. Fazer Pré-Inspeção
- Verificar se tem diferencial
- Confirmar tomadas com terra
- Fotografar quadro elétrico

**Ganho:** Orçamento mais rápido

### 4. Agendar Fora Época Alta
- Evitar junho-setembro (pico vendas)
- Preferir janeiro-março

**Ganho:** -2 dias agendamento

## Erros Comuns Que Atrasam

### ❌ Erro 1: Não Ter Acesso ao Quadro
**Problema:** Quadro trancado, chave perdida
**Solução:** Abrir antes da inspeção
**Atraso:** +1-2 dias

### ❌ Erro 2: Obras em Curso
**Problema:** Certificar antes de acabar obras
**Solução:** Esperar obras terminarem
**Atraso:** Certificação inválida

### ❌ Erro 3: Documentação Incompleta
**Problema:** Falta caderneta predial
**Solução:** Pedir 2ª via Finanças
**Atraso:** +5-10 dias

### ❌ Erro 4: Não Corrigir Não Conformidades
**Problema:** Ignorar lista correções
**Solução:** Fazer correções obrigatórias
**Atraso:** Certificado não emitido
...
**Não legalmente.** Desde 2007, é obrigatório para escritura de venda. Notário não lavra escritura sem certificado válido.

### 3. Quanto custa se instalação não estiver conforme?
**Depende das correções necessárias.** Casos comuns:
- Adicionar diferencial: 75-95€
- Mudar quadro completo: 370-650€
...
**Arrendamento:** Contrato inválido, multa até 3740€
**Seguro:** Pode recusar cobrir danos elétricos

### 6. Certificado de imóvel antigo é válido?
**Sim**, se instalação não foi alterada. Mas se fizer remodelação >50%, precisa novo certificado.
...
### Programa Eficiência Energética Edifícios

**Quem pode candidatar:**
- Proprietários imóveis >15 anos
- Remodelação elétrica + eficiência energética
...
**Como candidatar:** fundoambiental.pt

### IRS - Dedução Obras

**Dedução:** 15% despesas remodelação
**Máximo:** 500€/ano
**Inclui:** Certificação + correções elétricas
...
### 1 Semana Antes
- [ ] Agendar data inspeção
- [ ] Garantir acesso todas divisões
- [ ] Avisar inquilinos (se aplicável)
- [ ] Preparar questões para eletricista

### Dia da Inspeção
- [ ] Estar presente ou deixar chaves
- [ ] Quadro elétrico acessível
- [ ] Todas divisões abertas
- [ ] Animais presos (segurança)

### Após Inspeção
- [ ] Receber lista não conformidades
- [ ] Aprovar orçamento correções
- [ ] Agendar correções
...
*Preços válidos para Trás-os-Montes*
