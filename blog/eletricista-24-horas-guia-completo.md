...
❌ Preços abusivos (300-500€ por hora)
...
|------------|-----------|--------------|-------------|
| **Bragança centro** | 0km | 10-15 min | 15-20 min |
| **Gimonde** | 8km | 12-18 min | 15-22 min |
| **Rabal** | 10km | 15-20 min | 18-25 min |
| **Izeda** | 18km | 20-25 min | 25-30 min |
| **Rebordãos** | 12km | 15-22 min | 20-28 min |
| **Gostei** | 15km | 18-25 min | 22-30 min |
...
| Localidade | Distância | Tempo Normal | Tempo Noite |
|------------|-----------|--------------|-------------|
| **Vinhais** | 30km | 30-35 min | 35-40 min |
| **Macedo Cavaleiros** | 40km | 40-45 min | 45-50 min |
| **Ervedosa** | 35km | 35-40 min | 40-45 min |
| **Morais** | 45km | 45-50 min | 50-55 min |
...
| Localidade | Distância | Tempo Normal | Tempo Noite |
|------------|-----------|--------------|-------------|
| **Mirandela** | 65km | 60-65 min | 65-70 min |
| **Mogadouro** | 60km | 55-60 min | 60-65 min |
| **Vimioso** | 35km | 35-40 min | 40-45 min |
| **Alfândega da Fé** | 55km | 50-55 min | 55-60 min |
...
| Localidade | Distância | Tempo Normal | Tempo Noite |
|------------|-----------|--------------|-------------|
| **Chaves** | 95km | 80-85 min | 85-90 min |
| **Vila Real** | 120km | 90+ min | 95+ min |
| **Vidago** | 100km | 85-90 min | 90+ min |
...
| Localidade | Distância | Tempo Normal | Tempo Noite |
|------------|-----------|--------------|-------------|
| **Miranda do Douro** | 75km | 75-80 min | 80-85 min |
| **Sendim** | 80km | 80-85 min | 85-90 min |
| **Picote** | 85km | 85-90 min | 90+ min |
...
- Calor excessivo em cabos

**Perigo:** Incêndio iminente
...
**Sinais:**
- Aparelho dá choque ao tocar
- Formigueiro ao tocar torneira
- Choque ao tocar paredes húmidas
...
**Situações críticas:**
- Idosos sozinhos sem aquecimento
- Bebés/crianças pequenas
- Temperatura <5°C
- Equipamento médico elétrico

**Perigo:** Hipotermia, saúde

**O que fazer:**
1. Verificar se vizinhos têm corrente
2. Ligar 932 321 892
...
- Faíscas visíveis
- Estalo alto
- Disjuntor salta constantemente
- Luzes piscam violentamente
...
**Situações:**
- Inundação atingiu quadro/tomadas
- Chuva entrando em quadro exterior
- Cano rebentou perto instalação

**Perigo:** Choque fatal, curto-circuito
...
### Não É Urgência (Pode Esperar Segunda-Feira)

✅ **Tomada que não funciona** (se tiver outras)
✅ **Luz que pisca ocasionalmente** (1-2x/dia)
✅ **Interruptor partido** (se tiver alternativa)
✅ **Lâmpada LED que não acende**
✅ **Portão automático parado** (se abrir manual)
✅ **Campainha não toca**
✅ **Tomada USB não carrega**

**Poupança:** 25-50€ esperando dias úteis

### Urgência Moderada (Pode Esperar Manhã)

⚠️ **Disjuntor salta 1x/dia** (sem cheiro/fumo)
⚠️ **Luzes piscam raramente**
⚠️ **Tomada com mau contacto**
⚠️ **Quadro faz ruído leve**

**Recomendação:** Ligar de manhã, agendar dia útil
...
**Perguntamos:**
- Qual o problema?
- Há perigo imediato? (cheiro, faíscas, choque)
- Onde está? (morada exata)
- Contacto para SMS

**Duração:** 2-3 minutos

### PASSO 2: Diagnóstico Telefónico

**Fazemos perguntas:**
- Quadro está ligado?
- Vizinhos têm corrente?
- Há cheiro/fumo/faíscas?
- Quando começou?

**Objetivo:** Avaliar urgência e preparar equipamento
...
**Você decide:** Aceita ou não

**Duração:** 1-2 minutos

### PASSO 4: Técnico a Caminho

**Confirmamos:**
- Técnico saiu (nome + matrícula viatura)
- Tempo estimado chegada
- SMS com hora prevista
- Contacto direto técnico

**Você recebe SMS:**
"João a caminho. Chegada prevista 22h35. Viatura XX-00-XX. Tel: 932 321 892"

### PASSO 5: Chegada e Diagnóstico

**Técnico chega:**
- Identifica-se
- Avalia problema
- Confirma orçamento exato
- Explica o que vai fazer

**Você aprova:** Preço final antes de começar

**Duração diagnóstico:** 10-20 minutos
...
**Duração:** 30 min - 2 horas (conforme problema)

### PASSO 7: Pagamento e Garantia
...
### 3. E se não conseguirem arranjar?
**Não cobra mão de obra**, apenas deslocação. Mas 95% casos resolvemos no local.

### 4. Trabalham no Natal e Ano Novo?
**Sim, 365 dias/ano.** Preços iguais a domingos/feriados.

### 5. Posso agendar para hora específica?
**Sim**, mas urgências reais têm prioridade. Se agendar 10h e houver urgência às 9h30, pode atrasar 30-60 min.

### 6. Dão garantia em arranjos noturnos?
**Sim, 12 meses** igual a dias úteis. Se problema voltar, arranjamos grátis.
