...
Antes de começar, faça este teste rápido:

### Teste 1: É Só Esta Tomada?

**Teste outras tomadas da mesma divisão:**
- Se todas não funcionam → Problema no circuito (disjuntor, cabo)
- Se só uma não funciona → Problema na tomada específica

### Teste 2: É o Aparelho ou a Tomada?

**Teste com outro aparelho:**
1. Ligue outro aparelho na tomada (ex: carregador de telemóvel, lâmpada)
2. Se funcionar → Problema é o aparelho original
3. Se não funcionar → Problema é a tomada

### Teste 3: Verificar o Quadro Elétrico

**Vá ao quadro elétrico:**
1. Procure disjuntor desarmado (posição baixo)
2. Se encontrar, tente ligar
3. Se ficar ligado → Problema resolvido
4. Se desarmar imediatamente → Problema grave (curto-circuito)
...
- Geralmente todas da mesma divisão
- Disjuntor no quadro está na posição baixo
- Aconteceu após ligar aparelho potente

**Por que acontece:**
Sobrecarga (aparelhos a consumir mais que a capacidade do circuito) ou curto-circuito num aparelho.

**Solução: Ligar o disjuntor (Grátis - €150)**
...
- Outros aparelhos funcionam na mesma tomada
- Aparelho não funciona em nenhuma tomada
- Aparelho faz cheiro a queimado
...
2. Se não funcionar em nenhuma → Aparelho avariado
3. Não use (risco de incêndio)
...
- Cheiro a queimado
- Plástico derretido ou rachado
- Aconteceu após faísca ou estalo

**Por que acontece:**
Sobrecarga, curto-circuito, ligação solta, ou aparelho com defeito criou arco elétrico que queimou a tomada.

**⚠️ PERIGO: Risco de incêndio!**

**Solução: Substituir tomada (€15-80)**

**Materiais necessários:**
- Tomada nova (€5-20)
- Chave de fendas isolada (€3-8)
- Multímetro (€15-30) — para testar tensão
...
- Funciona se mexer na ficha
- Tomada aquece quando em uso
...
**Como identificar:**
- Tomada não funciona
- Não há sinais de queimadura
- Problema começou após obras, furar parede, ou pregar
- Outras tomadas do circuito podem não funcionar
...
- Ou parou de funcionar após instalação recente
- Instalação feita por não profissional
...
- Ficha não entra completamente
- Tomada é nova ou pouco usada

**Por que acontece:**
Mecanismo de proteção infantil está bloqueado ou rígido.

**Solução: Desbloquear mecanismo (Grátis)**

**Como fazer:**
1. Insira a ficha com mais força (mas sem forçar demais)
2. Rode ligeiramente enquanto empurra
3. Mecanismo deve ceder
4. Se não ceder, pode estar defeituoso → Substituir tomada
...
- Forno + micro-ondas
- Ferro + secador
- Vários aquecedores na mesma tomada

**Potência máxima por tomada:**
...
- Substitua tomadas danificadas
- Limpe poeira acumulada
...
**1. Posso usar tomada que aquece?**
**NÃO!** Tomada que aquece indica ligação solta ou sobrecarga. Risco de incêndio. Desligue o disjuntor e chame eletricista urgente.
...
**6. Extensão conta como várias tomadas?**
Não! Extensão partilha a mesma capacidade. Se tomada é 16A (3.680W), todas as tomadas da extensão juntas não podem exceder 3.680W.
...
Na maioria dos casos, tomada que não funciona tem **causa identificável e solução acessível**:
...
**Diagnóstico simples:**
1. Teste outro aparelho na tomada
2. Verifique quadro elétrico (disjuntor)
3. Inspeção visual (queimadura, oxidação)
4. Teste com multímetro (se tiver)

**Quando chamar eletricista:**
- Não consegue identificar a causa
- Sinais de queimadura ou cheiro
- Várias tomadas não funcionam
